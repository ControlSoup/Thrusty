from gaslighter import RocketEngineCEA, RocketEngineGeometry, convert, circle_area_from_diameter, pretty_dict, to_file, imperial_dictionary
...
to_file(pretty_dict(output), '../results/predicted_engine_results.md', file_name="Predicted Engine Results")

output = pretty_dict(imperial_dictionary(output))
to_file(output, '../results/predicted_engine_results_imperial.md', file_name="Predicted Engine Results Imperial")
