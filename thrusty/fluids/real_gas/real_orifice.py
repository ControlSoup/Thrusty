...
def real_orifice_mdot(
    ...
    if is_choked:
        ...
        def sonic_error(throat_pressure: float):
            ...
            sonic_throat_vel = gas_velocity(upstream.sp_enthalpy, sonic_throat.sp_enthalpy)
        ...
        throat = Throat(upstream.sp_entropy, throat_pressure_root_result.root, upstream.fluid)
        throat_vel = gas_velocity(upstream.sp_enthalpy, throat.sp_enthalpy)
