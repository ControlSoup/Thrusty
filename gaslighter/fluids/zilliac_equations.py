...
def eq_23(
    ...
    return (total_sp_internal_energy - liquid_sp_internal_energy) / (vapor_sp_internal_energy - liquid_sp_internal_energy)
...
def eq_28(
    ...
    return (
        qdot_liquid_surf - qdot_surf_vapor
...
def eq_29(
    ...
    return (pressure - sat_pressure) * vapor_volume / (vapor_comp_factor * vapor_gas_trival_lookup * vapor_temp * dt)

def half_eq_32(
    pP_pT_from_rho: float,
    dTdt: float,
    pP_prho_from_T: float,
    drho_dt: float
):
