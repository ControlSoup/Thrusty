...
class Throat:
    ...
    def sp_enthalpy(self):
        return PropsSI("HMASS", "SMASS", self.sp_entropy, "P", self.pressure, self.fluid)

    @property
    def density(self):
        return PropsSI("D", "SMASS", self.sp_entropy, "P", self.pressure, self.fluid)

    @property
    def speed_of_sound(self):
        return PropsSI("A", "SMASS", self.sp_entropy, "P", self.pressure, self.fluid)
...
def real_orifice_mdot(
    ...
    # Assume unchoked is plausable
        ...
        try:
            ...
            raise ValueError(f"ERROR| Throat Lookup Failed: {e}")
